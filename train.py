...
message = tk.Label(window, text="Face Recognition Based Attendance", bg="#a53b3b", fg="white", width=50, height=3,
                   font=("Courier New", 30, 'bold'))
message.place(x=200, y=20)

lbl = tk.Label(window, text="Enter Your College ID", width=28, height=2, fg="red", bg="yellow",
               font=('times', 15, ' bold '))
...
clearButton = tk.Button(window, text="Clear", command=clear, fg="red", bg="yellow", width=28, height=2,
                        activebackground="Red", font=('times', 15, ' bold '))
clearButton.place(x=950, y=200)
clearButton2 = tk.Button(window, text="Clear", command=clear2, fg="red", bg="yellow", width=28, height=2,
                         activebackground="Red", font=('times', 15, ' bold '))
